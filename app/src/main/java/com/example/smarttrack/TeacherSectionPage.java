...
public class TeacherSectionPage extends AppCompatActivity {
    ...
    private List<SectionModel> originalList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_section_page);
        ...
        adapter = new SectionAdapter(TeacherSectionPage.this, dataList, db, "",TeacherSectionPage.this);
        ...
        cbQuarters.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (selectedQuarter.equals("1st Quarter")) {
                    ...
                    adapter = new SectionAdapter(TeacherSectionPage.this, dataList, db, selectedQuarter, TeacherSectionPage.this);
                    recyclerView.setAdapter(adapter);
                    ...
                    List<SectionModel> dataList2 = new ArrayList<>();

                    // Now you have the selected quarter, you can create the adapter and populate the RecyclerView
                    adapter = new SectionAdapter(TeacherSectionPage.this, dataList2, db, selectedQuarter, TeacherSectionPage.this);
                    recyclerView.setAdapter(adapter);
                    // Fetch students based on the selected quarter
        ...
        ArrayAdapter<CharSequence> quarterAdapter = ArrayAdapter.createFromResource(this,
                R.array.Quarters, R.layout.custom_spinner_item);
    ...
    private void filterData(String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (SectionModel model : originalList) {
        ...
        db.collection("Classes").document(classCode)
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                        ...
                        String firstQuarterGrade = documentSnapshot.getString("grades.1st Quarter");
                        Double firstGrade = null;


                        // Parse grades to Double if not null
                        if (firstQuarterGrade != null) {
                            firstGrade = Double.valueOf(firstQuarterGrade);
                        }
                        ...
                        String firstGradeString = firstGrade != null ? String.valueOf(firstGrade) : "N/A";
                        originalList.add(new SectionModel(studentFirstName + " " + studentLastName, profilePictureUrl, classCode, LRN, email, studentFirstName, studentLastName, restricted,"Grade: " + firstGradeString,""));
                    }
                    dataList.addAll(originalList);
                    adapter.notifyDataSetChanged();
                })
    ...
    public void fetchStudentsByClassCode2(String classCode, List<SectionModel> dataList2) {
        db.collection("Classes").document(classCode)
                .collection("Students")
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                        ...
                        String email = documentSnapshot.getString("email");
                        String firstQuarterGrade = documentSnapshot.getString("grades.1st Quarter");
                        String secondQuarterGrade = documentSnapshot.getString("grades.2nd Quarter");

                        Double firstGrade = null;
                        Double secondGrade = null;
                        Double average = null;
                        ...
                        if (secondQuarterGrade != null) {
                            secondGrade = Double.valueOf(secondQuarterGrade);
                        }
                        ...
                        String secondGradeString = secondGrade != null ? String.valueOf(secondGrade) : "N/A";
                        String averageString = average != null ? String.valueOf(average) : "N/A";
                        dataList2.add(new SectionModel(studentFirstName + " " + studentLastName, profilePictureUrl, classCode, LRN, email, studentFirstName, studentLastName, restricted, "Grade: " +secondGradeString, "Average: " + averageString));
                    }
