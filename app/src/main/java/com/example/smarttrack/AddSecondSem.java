...
public class AddSecondSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_second_sem);
...
// Set custom end icon click listener
    ...
    private void addClassToFirestore() {
        ...
        if (section.isEmpty() || code.isEmpty() || subject.isEmpty()) {
            Toast.makeText(AddSecondSem.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        classData.put("semester", "2nd Semester");
        ...
        db.collection("Classes").document(code).set(classData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(AddSecondSem.this, "Class added successfully", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddSecondSem.this, "Failed to add class: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
